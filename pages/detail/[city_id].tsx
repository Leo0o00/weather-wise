...
import modifyWeatherDescription from "@/common/algorithms/startWithUpperCase";
...
export async function getServerSideProps(context: GetServerSidePropsContext) {
    ...
    modifyWeatherDescription(weatherData);
...
export default function cityId({city, weather}: Props) {
                    ...
                    <div className="bg-blue-500 rounded p-4">
                        <div className="grid grid-cols-2">
                            ...
                            <div className="justify-self-end">
                                ...
                                <div className="text-white text-sm te">{weather.weather[0].description}</div>
                            </div>
                        </div>
                    </div>
                </div>
